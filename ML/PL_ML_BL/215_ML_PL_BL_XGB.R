# ---
# title   : 215_NL_PL_BL_XGB
# version : 1.0
# author  : 2e consulting
# desc.   : 보험계약대출예측모델 eXtreme Gradient Boosting 튜닝
# ---
...
# sort grid
sortedGrid <- h2o.getGrid("Cartesian_Grid_XGB",sort_by = "AUC",decreasing = T)
...
hyper_params <- list( 
  ...
  max_abs_leafnode_pred = c(0,1,2,3,4,5),
...
# print grid
sortedGrid = h2o.getGrid("Random_Grid_XGB",sort_by="AUC",decreasing=T)
print(sortedGrid)
